        ...
        <el-row class="layout-page-heading">
            <el-col :span="16">
                ...
                <el-breadcrumb separator="/">
                    ...
                    <el-breadcrumb-item>编辑字典</el-breadcrumb-item>
                </el-breadcrumb>
            </el-col>
            <el-col :span="8">
        ...
        methods: {
            save(){
                ...
                this.$refs.dict.validate((valid)=> {
                    if (valid) {
                        api.request('admin/system/dict/update', data, (res)=> {
            ...
            init(){
                api.request('admin/system/dict/get', {id: this.$route.query.id}, (res)=> {
                    this.dict.value = res.data.value,
                    this.dict.label = res.data.label,
                    this.dict.type = res.data.type,
                    this.dict.remark = res.data.remark,
                    this.dict.sort = res.data.sort
                })
            }
        },
        created() {
