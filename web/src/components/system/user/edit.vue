    ...
    <div>
        ...
        <div class="layout-page-box">
            <el-form label-width="80px" label-position="right" :model="user" :rules="rules" ref="user"
                ...
                <el-form-item label="密码" prop="password" @change="resetForm('user')">
                    <el-input type="password" v-model="user.password" placeholder="密码" :maxlength="16"></el-input>
                </el-form-item>
                <el-form-item label="确认密码" prop="verifyPassword" class="is-required" v-bind:class="{'verifyPasswordFlag':verifyPasswordFlag}">
        ...
        methods: {
            save(){
                ...
                this.$refs.user.validate((valid)=> {
                    if (valid) {
                        api.request('admin/system/user/update', data, (res)=> {
            ...
            init(){
                api.request('admin/system/user/get', {id: this.$route.query.id}, (res)=> {
